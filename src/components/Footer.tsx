export default function Footer({ whiteBackground = false }: { whiteBackground?: boolean }) {
  return (
    <footer className={whiteBackground ? "bg-gray-50 py-12" : "bg-gradient-to-r from-orange-50 to-red-50 py-12"}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-xl p-8 border-l-4 border-orange-500">
